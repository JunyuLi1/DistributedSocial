...
prof_obj.load_profile(r'C:\Users\richa\PycharmProjects\Ics32\32assignment\Test\testtest.dsu')
...
for item in past_data:
    if item['from'] not in prof_obj.friend_username:
        ...
        prof_obj.save_profile(r'C:\Users\richa\PycharmProjects\Ics32\32assignment\Test\testtest.dsu')
    else:
        prof_obj.add_history_to_username(item['from'], item['message'])
        prof_obj.save_profile(r'C:\Users\richa\PycharmProjects\Ics32\32assignment\Test\testtest.dsu')
